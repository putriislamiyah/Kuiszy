...
<div class="row">
    <div class="col-sm-12 text-center">
        ...
        <?php
        $no = 1;
        $soal = mysqli_query($con, "SELECT * from tbl_soal WHERE kategori = $kat LIMIT 10 ");
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                if (myarr[0] == 'jawaban anda benar, anda dapat 4 point') {
                                    ...
                                    // error.play();
                                    var succes = new Audio('../music/error.mp3');
                                    succes.play();
                                    swal({
                                        title: "Salah !",
                                        text: myarr[0],
...
<script type="text/javascript">
    ...
    //     console.log('COK');
    // }
    // console.log($("#form_jawab_<?= $no - 1 ?>").submit());
    // $("#form_jawab_<?= $no ?>").submit();
    $("#form_jawab_<?= $no - 1 ?>").submit(function() {
        leaderboard();
    });
    ...
    function timer(secs) {
        ...
        if (mins_rem == "00" && secs_rem < 1) {
            ...
            swal({
                ...
                // confirmButtonText: '<a href="go.php"></a>',
    ...
    console.log(<?php echo $total_time; ?>);
